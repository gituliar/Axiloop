...
UT$BeginTestCase["NLO-D"];
  ...
  UT$AssertEquivalent[
    $virt
    ,
    aspi^2 ( pqq (-7 - 2 Li2[1-x] + 2 Log[x]^2 + 8 Li2[1] - 12 I1 + 4 I0 Log[x] + 4 I0 Log[1-x] + (-3 + 2 Log[x] + 4 Log[1-x] + 8 I0) Log[1-x]) + (1-x) (-3 + 2 Log[x] + 4 Log[1-x] + 8 I0) + x)
  ];

  $real = aspi^2 (pqq ((8 - 4 (Log[1-x] - Log[x])) (I0 + Log[1-x]) + 4 (I1 + (Log[1-x])^2/2) + 2 Li2[1-x] - 2 Li2[1] - Log[x]^2) + 1/(1-x) (-Log[x] - 2 x^2 Log[x] - 3 x (1+x) - 2));
