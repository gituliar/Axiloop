  ...
  Begin["`Private`"] 
    ...
    $$SimplifyTranslate[expr_] := Module[
      ...
      simplifyRules = {
        ...
        $$[{     },{0,p,q},{ }]  :>   $$[{},{0,k,p},{}],
        $$[{x_   },{0,p,q},{ }]  :> - $$[{x},{0,k,p},{}] - x.p $$[{},{0,k,p},{}],
        $$[{x_,y_},{0,p,q},{ }]  :>   $$[{x,y},{0,k,p},{}] + x.p $$[{y},{0,k,p},{}] + y.p $$[{x},{0,k,p},{}] + x.p y.p $$[{},{0,k,p},{}],

        $$[{     },{  p,q},{q}]  :>   $$[{ },{0, k},{0}],
        $$[{   x_},{  p,q},{q}]  :>   $$[{x},{0, k},{0}] - x.q $$[{},{0, k},{0}],
        $$[{     },{0,p,q},{q}]  :> - $$[{ },{0,k,p},{k}],
        $$[{   x_},{0,p,q},{q}]  :>   $$[{x},{0,k,p},{k}] + x.p $$[{},{0,k,p},{k}],
        $$[{x_,y_},{0,p,q},{q}]  :> - $$[{x,y},{0,k,p},{k}] - x.p $$[{y},{0,k,p},{k}] - y.p $$[{x},{0,k,p},{k}] - x.p y.p $$[{},{0,k,p},{k}],
